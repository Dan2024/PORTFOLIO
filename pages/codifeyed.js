...
export default function Codifeyed() {
  return (
    <>
      <Head>
        <title>CODIFEYED Project</title>
        <meta
          name='description'
          content='More info on my project exploring computer science topics'
        />
      </Head>
          ...
          <section className=' child:shadow-2xl child:rounded-xl child:my-10 child:mx-5'>
            <div className='md:grid grid-cols-hero-layout '>
              <div className='p-5 child:pb-10'>
                ...
                <p>
                  I initially tried this is in React setting the unsorted array
                  in state however the animation was extremely clunky.
                  Researching why I diagnosed this was likely due to the fact
                  react 'batches' multiple state updates as one state update.
                  Ultimately I ended up using P5.js for the animations as it has
                  a draw function that you can run on a loop meaning each stage
                  of the sorting algorthm could be seen, thus making the
                ...
                <p>
                  ...
                  merge). Although challenging, I'm glad I attempted this one as
            ...
            <div className='md:grid grid-cols-2-col-grid__expand-two'>
              <div className='p-5 child:pb-5 col-start-2'>
                ...
                <p>
                  I explored the Fractal Trees to learn about recursive
                  functions (... and because i thought they looked really cool).
                  Using this{' '}
                  <a
                    className='text-[#528998] underline'
