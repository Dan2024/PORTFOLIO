  ...
  return (
    <>
      <Head>
        ...
        <meta
          name='description'
          content='A more in depth look at my how I made my portfolio'
        />
      </Head>
          ...
          <section className=' child:shadow-2xl child:rounded-xl child:my-10 child:mx-5'>
            <div className='md:grid grid-cols-hero-layout '>
              <div className='p-5 child:pb-10'>
                ...
                <p>
                  ...
                  production level apps and I thought that this portfolio
                  website would be a great opportunity to gain some experience
                  with Next.
                </p>
                <p>
                  ...
                  calls and the information wont be changing consistently I
                  opted to generate this site statically.
                </p>
                ...
                <p>
                  ...
                  industry. I'd also used tailwind on other projects and so I
                  was able to style my website quite time efficiently.
                </p>
              </div>
            </div>
            ...
            <div className='lg:grid grid-cols-2-col-grid__expand-two'>
              <div className='p-5 child:pb-5 col-start-2'>
                ...
                <p>
                  I noticed all the most impressive looking websites in my
                  opinion were made using the{' '}
                  <a
                    target='_blank'
                    rel='noreferrer'
                    className='text-portfolio-blue underline'
                  ...
                  library and because of this I was really eager to implement
                  some 3D web graphics of my own in my portfolio.
                </p>
                <p>
                  I used{' '}
                  <a
                  ...
                  (a react renderer for Three.js) to implement Three.js in
                  react. I started out just trying to get a simple box to render
                  on the screen and follow my mouse. Eventually after I had
                  managed this I took to blender to create the 3D monitors
                  displaying my projects. I then later managed to get my custom
                  monitor to follow my mouse, the only problem was that it was
                ...
                <p>
                  ...
                  website fast again (and stopped my laptop from turning to
                  lava).
                </p>
              </div>
              <div
            ...
            <div className='md:grid grid-cols-hero-layout'>
              <div className='p-5 child:pb-5'>
                ...
                <p>
                  ...
                  which allowed, in my opinion, for a more unique way to draw
                  the users attention to key bits of text. This Coupled with the{' '}
                  <a
                    className='text-portfolio-blue underline'
                    target='_blank'
                    rel='noreferrer'
                  ...
                  allowed me to trigger these subtle animations whenever a
                  certain element was visible to the user.
                </p>
                {/* <p>
                I also used{' '}
                <a
